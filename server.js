...
app.listen(PORT, async () => {
    ...
    // Conectar WhatsApp apenas em desenvolvimento
    if (NODE_ENV !== 'production') {
        console.log('\n🔄 Conectando ao WhatsApp (apenas desenvolvimento)...');
        await connectToWhatsApp();
    } else {
        console.log('\n⚠️ WhatsApp Baileys desabilitado em produção no Render');
        console.log('💡 Use CallMeBot como canal principal');
    }
